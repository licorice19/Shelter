...
<html lang="ru">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Обратная связь<span class="sr-only">(current)</span></a>
      </li>
                        ...
                        <div class="col">
                          <div class="row">
                            <div class="col interface border">
                              <p class="info">Cписок заявок на выполнение контрактов</p>
                            </div>
                          </div>
                        </div>
          </div>
          <div class="row req-list justify-content-center">
